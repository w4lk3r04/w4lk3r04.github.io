          ...
          <div className="grid lg:grid-cols-12 gap-8 items-start">
            <div className="lg:col-span-5">
              <div className="p-6 border-4 border-green-700 rounded-md bg-white dark:bg-black">
                ...
                <div className="mt-6">
                  ...
                  <ul className="mt-3 text-lg text-gray-600 dark:text-gray-300 list-disc list-inside">
                    <li>Security / SOC related certifications (add specifics in your CV)</li>
                    <li>Other industry certs</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="lg:col-span-7">
              <div className="p-6 border-4 border-green-700 rounded-md bg-white dark:bg-black">
                ...
                <div className="mt-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <div className="text-lg font-bold dark:text-white">Security Associate — Rapidops Inc.</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">Jan 2024 – Present</div>
                        <div className="mt-2 text-gray-700 dark:text-gray-300">SOC analysis, detection engineering, and proactive threat hunting to reduce dwell time and strengthen incident response.</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="w-2 h-full bg-green-600 rounded" />
                      <div>
                        <div className="text-lg font-bold dark:text-white">Cyber Security Analyst — EF Education First</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">Jul 2022 – Dec 2023</div>
                        <div className="mt-2 text-gray-700 dark:text-gray-300">Hands-on analysis and incident investigations across web and network platforms.</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  <h4 className="text-2xl font-bold dark:text-white">Skills</h4>
                  <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      <div className="text-lg font-medium dark:text-white">Technical Skills</div>
                      <ul className="mt-2 text-gray-700 dark:text-gray-300 list-disc list-inside">
                        <li>SOC Analysis & Detection Engineering</li>
                        <li>Threat Hunting & Threat Intelligence</li>
                        <li>SIEM, EDR, and Log Analysis</li>
                        <li>Web App & Network Security</li>
                      </ul>
                    </div>
                    <div>
                      <div className="text-lg font-medium dark:text-white">Soft Skills</div>
                      <ul className="mt-2 text-gray-700 dark:text-gray-300 list-disc list-inside">
                        <li>Communication & Reporting</li>
                        <li>Incident Triage & Prioritization</li>
                        <li>Collaboration with Engineering Teams</li>
                      </ul>
                    </div>
                  </div>
                </div>
        ...
        <section className="bg-white dark:bg-black ">
          ...
          <dl className="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
              <div className="flex flex-col items-center justify-center">
                  ...
                  <dd className="font-light text-2xl text-gray-500 dark:text-gray-400">CTF Challenges Solved</dd>
              </div>
              <div className="flex flex-col items-center justify-center">
                  <dt className="mb-2 text-5xl md:text-7xl font-extrabold">
                      <span data-counter-target="15">0</span>+
                  </dt>
                  <dd className="font-light text-2xl text-gray-500 dark:text-gray-400">Bug Bounties Awarded</dd>
              </div>
              <div className="flex flex-col items-center justify-center">
                  <dt className="mb-2 text-5xl md:text-7xl font-extrabold">
                      <span data-counter-target="3">0</span>
                  </dt>
                  <dd className="font-light text-2xl text-gray-500 dark:text-gray-400">Security Certifications</dd>
              </div>
          </dl>
                    </div>
        ...
        {/* #### SERVICES SECTION #### */}
          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 text-center">
              ...
              <div className="max-w-screen-md mb-8 lg:mb-12 mx-auto">
                ...
                CTF Achievements & Security Research
                </h2>
                <p className="text-gray-500 text-2xl dark:text-gray-400">
                Proven track record in CTF competitions. Specializing in web application security, OSINT and Threat Intelligence. Contributing to the security community through detailed write-ups and research.
                </p>
              </div>
              ...
              <div className="transform transition-all duration-300 hover:scale-105 group">
                ...
                <div className="transform transition-all duration-300 hover:scale-105 group">
                  ...
                  <h3 className="mb-2 text-3xl font-bold dark:text-white">SOC Analysis & Pro-active Threat Detection</h3>
                  <p className="text-gray-500 text-xl dark:text-gray-400">
                    Conduct continuous SOC analysis and proactive threat detection — hunting for indicators of compromise, building detections, and reducing mean time to detect and respond.
                  </p>
                </div>
                <div className="transform transition-all duration-300 hover:scale-105 group">
                  <div className="flex justify-center mx-auto items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <div className="max-w-screen-xl px-4 pb-8 mx-auto text-center lg:pb-16 lg:px-6">
            <figure className="max-w-screen-md mx-auto">
              ...
              <p className="text-2xl font-medium py-8 text-gray-900 dark:text-white">
                "Sp1der04's CTF solutions and security research have been invaluable to our platform. Their deep understanding of web security and creative approach to problem-solving helped us identify and fix several critical vulnerabilities. Their write-ups are clear, detailed, and educational."
              </p>
            </blockquote>
